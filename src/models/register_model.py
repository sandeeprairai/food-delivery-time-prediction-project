...
# initialize dagshub
import dagshub
dagshub.init(repo_owner='sandeeprairai', repo_name='food-delivery-time-prediction-project', mlflow=True)


# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/sandeeprairai/food-delivery-time-prediction-project.mlflow")
